...
Question.prototype.randQuest = function() {
    var quizLength = quizArr.length;
    var rand = Math.floor((Math.random() * quizLength - 1) + 1);
    console.log(quizArr[rand].question);
    ...
    var answer = quizArr[rand].correctAnswer + 1;
